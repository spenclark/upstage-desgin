     ...
     <div className='slide__div '>
      ...
      <div className='slide__div__inverted '>
        ...
        <div className='slide__content'>
          ...
          <div className='slide__text'>
            <p>
              Upstage Design reorganizes and restructures properties into spaces buyers love. Blending the clients inventory and our own to make full use of a home. <span style={{fontWeight: "600"}}>We work hard to make sure that the property is ready for the market.</span>
            </p>
          </div>
        </div>
      </div>
